...
export class HomeComponent {
  ...
  readonly roadmap: Milestone[] = [
    ...
    { tag: 'v0.16', state: 'shipped', what: 'Predictive parity push — VersionProbe implementations for NuGet, Packagist, Pub, Hex, Hackage, CRAN, CocoaPods, Conda, CPAN. Cooldown / publisher-change / maintainer-trust / version-diff now fire across 15 ecosystems (was 6).' },
    { tag: 'v0.17', state: 'planned', what: 'AI/ML supply chain — HuggingFace pickle, PyTorch/TF model files, MCP / agent-framework auditor' },
    { tag: 'v0.18', state: 'planned', what: 'IaC supply chain — Terraform / OpenTofu / Helm / Ansible Galaxy' },
    { tag: 'v0.19', state: 'planned', what: 'Emerging surfaces — devcontainer features + slopsquatting + plugin-manager inventory + PlatformIO' },
